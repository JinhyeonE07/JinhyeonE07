...
<style xmlns="http://www.w3.org/2000/svg">
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 31.066609273138347;
      }
    }
  ...
  <g xmlns="http://www.w3.org/2000/svg" data-testid="main-card-body" transform="translate(0, 55)">
    ...
    <svg data-testid="icon" class="icon" viewBox="0 0 16 16" version="1.1" width="16" height="16">
      ...
      <text class="stat  bold" x="219.01" y="12.5" data-testid="stars">59.1k</text>
    </g>
    ...
    <svg data-testid="icon" class="icon" viewBox="0 0 16 16" version="1.1" width="16" height="16">
      ...
      <text class="stat  bold" x="219.01" y="12.5" data-testid="commits">145</text>
    </g>
    ...
    <svg data-testid="icon" class="icon" viewBox="0 0 16 16" version="1.1" width="16" height="16">
      ...
      <text class="stat  bold" x="219.01" y="12.5" data-testid="issues">139</text>
    </g>
  </g>
    </svg>
